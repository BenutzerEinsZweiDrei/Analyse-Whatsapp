...
def main():
    ...
    if topic_insights['highest_reciprocity_topics']:
        print(f"   - Highest reciprocity topics: {[t['topic'] for t in topic_insights['highest_reciprocity_topics']]}")
    ...
    print(f"     - dominant_emotion_counts: {len(merged_v1['basic_metrics']['dominant_emotion_counts'])} emotions")
