...
from app.core.parser import parse_conversations, Message
...
class TestEmojis(unittest.TestCase):
    ...
    def test_evaluate_emoji_labels(self):
        ...
        result = evaluate_emoji_string(["😊", "😄"])
        self.assertIn(result, ["sehr positiv", "eher positiv", "neutral", 
                              "eher traurig", "sehr traurig"])
...
class TestSecurityNoHardcodedKeys(unittest.TestCase):
    ...
    def test_no_hardcoded_keys_in_streamlit_app(self):
        ...
        self.assertNotIn(old_jina_key, content, 
                        "Old hard-coded Jina API key found in streamlit_app.py")
        self.assertNotIn(old_textrazor_key, content,
                        "Old hard-coded TextRazor API key found in streamlit_app.py")
    ...
    def test_no_hardcoded_keys_in_config(self):
        ...
        self.assertNotIn(old_jina_key, content,
                        "Hard-coded Jina API key found in app/config.py")
        self.assertNotIn(old_textrazor_key, content,
                        "Hard-coded TextRazor API key found in app/config.py")
